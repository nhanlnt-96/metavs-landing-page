    ...
    <Row className="roadmap-comp-phase-1">
      <Container fluid className="phase-two-col-container">
        <Row className="phase-1-title">
          ...
          <Col data-aos="zoom-in" xl={6} lg={7} md={8} sm={12} className="phase-1-title-item">
        ...
        <Row className="phase-two-col-btn">
          <Col xl={6} lg={5} md={4} sm={12}/>
          <Col data-aos="zoom-in-up" xl={6} lg={7} md={8} sm={12} className="d-flex justify-content-center align-items-center">
            <button className="comp-primary-btn">SHOW MORE
              <BiRightArrowAlt className="comp-primary-btn-icon"/>
            </button>
          </Col>
        </Row>
        <Row data-aos="fade-up" className="phase-scroll-down d-flex justify-content-center align-items-center">
